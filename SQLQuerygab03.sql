...
--TOP 100 vendas, de acordo com a quantidade vendida. Você precisa fazer isso em 10min pois o diretor de compras solicitou essa informação para apresentar em uma reunião.

--Utilize seu conhecimento em SQL para buscar essas TOP 100 vendas, de acordo com o total vendido (SalesAmount).

-- TABELA FactSales SalesAmount Valor Vendido
...
--mesmo preço. Porém, a empresa quer diferenciar esses preços de acordo com o peso (Weight) de cada um.
...
--dimensionar o transporte de todos os produtos em categorias, de acordo com o peso.
...
--Tabela DimStore 'Loja'
--StoreName 'Nome da Loja'
--OpenDate 'Data de Abertura'
--EmployeeCount ' Quantidade de Funcionarios'
--StoreType - Tipo de Loja (Ex: Fisíca, Digital. Catalogo)
...
--TABELA DimProduct
-- Coluna BrandName (Encontrar a Marca)
...
--informações de lojas. Mas você precisa apenas das lojas que não estão mais funcionando atualmente. 
...
--desconto no próximo mês. O seu trabalho é fazer uma consulta à tabela DimProduct e retornar os ID’s, Nomes e Preços de todos os produtos LCD existentes.
--SELECT * FROM DimProduct
...
--EX10
--A empresa possui 15produtos da marca Contoso, da cor Silver e com um UnitPrice entre 10 e 30. Descubra quais são esses produtos e ordene o resultado em ordem decrescente de acordo com o preço (UnitPrice).
